...
public class MapGenerator : MonoBehaviour
{
	...
	public bool colorByTerrainType;
	...
	MapData GenerateMapData(Vector2 centre)
	{
		...
		{	
			...
			return new MapData(heightMap, vegetationMap, moistureMap, windXMap, windZMap, rgbMap);
		}
		

		return new MapData(heightMap, vegetationMap, moistureMap, windXMap, windZMap, regions);
	}
...
public struct MapData
{
	...
	public MapData(float[,] elevationMap, int[,] vegetationMap, float[,] moistureMap, 
				   float[,] windXMap, float[,] windZMap, TerrainType[] regions)
	{
	...
	public MapData(float[,] elevationMap, int[,] vegetationMap, float[,] moistureMap, 
				   float[,] windXMap, float[,] windZMap, Color[] colourMap)
	{
		this.elevationMap = elevationMap;
		this.vegetationMap = vegetationMap;
		this.moistureMap = moistureMap;
